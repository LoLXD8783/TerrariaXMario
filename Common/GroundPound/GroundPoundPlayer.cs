...
using TerrariaXMario.Common.Stomp;
using TerrariaXMario.Content.Cap;
using TerrariaXMario.Utilities.AssetData;

namespace TerrariaXMario.Common.GroundPound;
...
internal partial class GroundPoundPlayer : ModPlayer
{
    ...
    public override void ProcessTriggers(TriggersSet triggersSet)
    {
        ...
        {
            Player.FlipJumpPlayer.Init(120, new Vector2(Player.Size.X * 0.5f, Player.Size.Y * (Player.gravDir == 1 ? 0.75f : 0.25f)));
