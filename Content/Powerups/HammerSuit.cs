...
//    {
//        Projectile.NewProjectile(player.GetSource_FromThis(), player.MountedCenter, TerrariaXMario.GetInitialProjectileVelocity(player, 0.3f), ModContent.ProjectileType<HammerSuitHammer>(), player.GetModPlayerOrNull<CapEffectsPlayer>()?.StatPower ?? 1, 0f, player.whoAmI);
